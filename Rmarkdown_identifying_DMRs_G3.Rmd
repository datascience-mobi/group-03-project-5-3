...
# Changing all beta values of promoters with corresponding coverage value <25 into NA (due to paper) and > 14175 into NA (due to kneedle analysis)
for (j in 21:40) {
...
# $\color{blue}{\text{Normalisation and Impuatation}}$
...
> Eqation for normalisation:  $M = \ln(Beta/(1-Beta))$ 
